...
import 'package:sportify_application/Screen/advertisments.dart';
import 'package:sportify_application/Screen/gym_policies.dart';
import 'package:sportify_application/Screen/subscription.dart';
import 'package:sportify_application/Screen/type.dart';
import 'package:sportify_application/widget/list_of_sports.dart';
                 ...
                 Row(
                  ...
                  children: [
                    TextButton(onPressed: (){
                       Navigator.push(context, MaterialPageRoute(builder: (context)=>gym_policies()));
                
                    }, child: Text('سياسات النادي',style: TextStyle(color:Colors.white,shadows: [BoxShadow(color:Colors.blueGrey.shade300,offset: Offset(5, 5),blurRadius: 10)]),)),
                    SizedBox(width: 25,),
                    TextButton(onPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>type()));

                    }, child: Text('الأشتراك',style: TextStyle(color:Colors.white,shadows: [BoxShadow(color:Colors.blueGrey.shade300,offset: Offset(5, 5),blurRadius: 10)]),)),
                   SizedBox(width: 25,),
                   TextButton(onPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>advertisments()));
                   }, child: Text('الاعلانات',style: TextStyle(color:Colors.white,shadows: [BoxShadow(color:Colors.blueGrey.shade300,offset: Offset(5, 5),blurRadius: 10)]),)),
