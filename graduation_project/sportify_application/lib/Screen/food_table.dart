...
import 'package:sportify_application/widget/customcard.dart';
import 'package:sportify_application/widget/home_appbar%20_exersice.dart';

class food_table extends StatelessWidget {
  const food_table({super.key});
            ...
            fit: BoxFit.cover,
              ...
              children: [
                ...
                const SizedBox(height: 40.0),
                 Text('اجمالي السعرات اليومية:150 سعرة حرارية',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                     const SizedBox(height: 40.0),
                Row(
                ...
                Row(
                 ...
                 Center(
                  ...
                  children: [
                     Text('لاتنسى الأكثار من شرب الماء',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                   const  SizedBox(height:10),
                  Text('التقليل من السكريات',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                      const  SizedBox(height:10),
                    Text('التقليل من النشويات',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
